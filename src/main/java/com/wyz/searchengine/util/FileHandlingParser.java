 ...
 * Updated - 08/14/2017
 * Name - Arvind
 * Description - Created a class to handle the different types of file inputs in the same folder
 * This can handle each input that is present.
 * For PDF it is outside
 */
...
public class FileHandlingParser {
